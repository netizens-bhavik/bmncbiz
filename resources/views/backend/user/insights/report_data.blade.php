<div class="flex-row-fluid ml-lg-8">
                ...
                <div class="card-body pt-5">
                    ...
                    <div class="d-flex align-items-center mb-6">
                        ...
                        <div class="d-flex flex-wrap flex-row-fluid">
                            ...
                            <div class="d-flex flex-column pr-5 flex-grow-1">
                                <a href="#"
                                   class="text-dark text-hover-primary mb-1 font-weight-bolder font-size-lg">Ana
                                    Larson</a>
                    ...
                    <div class="d-flex align-items-center mb-6">
                        ...
                        <div class="d-flex flex-wrap flex-row-fluid">
                            ...
                            <div class="d-flex flex-column pr-5 flex-grow-1">
                                <a href="#"
                                   class="text-dark text-hover-primary mb-1 font-weight-bolder font-size-lg">Jhonny
                                    Harden</a>
                                <span class="text-muted font-weight-bold">UI/UX, Art Director</span>
                            </div>
                            <!--end::Text-->
        ...
        <div class="col-lg-6">
            ...
            <div class="card card-custom card-stretch gutter-b">
                ...
                <div class="card-header border-0 pt-6">
                    <h3 class="card-title align-items-start flex-column">
                                    <span
                                        class="card-label font-weight-bolder font-size-h4 text-dark-75">Recent Posts</span>
                        <span class="text-muted mt-3 font-weight-bold font-size-lg">Avarage +47%</span>
                    </h3>
                    <div class="card-toolbar">
                        <div class="dropdown dropdown-inline" data-toggle="tooltip" title=""
                ...
                <div class="card-body pt-7">
                    ...
                    <div class="d-flex align-items-center pb-9">
                        ...
                        <div class="d-flex flex-column flex-grow-1">
                            <!--begin::Title-->
                            <a href="#"
                               class="text-dark-75 font-weight-bolder text-hover-primary font-size-lg mb-1">Quickly
                                direct you to useful content or people</a>
                            <!--end::Title-->
                            <!--begin::Desc-->
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="symbol symbol-70 symbol-2by3 flex-shrink-0 mr-6">
                            <div class="symbol-label"
                                 style="background-image: url('assets/media/stock-600x400/img-34.jpg')"></div>
                        </div>
                        <!--end::Symbol-->
                        <!--begin::Section-->
                        <div class="d-flex flex-column flex-grow-1">
        ...
        <div class="col-lg-6">
            ...
            <div class="card card-custom card-stretch gutter-b">
                ...
                <div class="card-header border-0 pt-6">
                    <h3 class="card-title align-items-start flex-column">
                                    <span
                                        class="card-label font-weight-bolder font-size-h4 text-dark-75">Weekly Sales</span>
                        <span class="text-muted mt-3 font-weight-bold font-size-lg">28 Daily Avg.</span>
                    </h3>
                    <div class="card-toolbar">
                        <div class="dropdown dropdown-inline" data-toggle="tooltip" title=""
                             data-placement="left" data-original-title="Quick actions">
                ...
                <div class="card-body">
                    <!--begin::Container-->
                    <div class="d-flex justify-content-between flex-column h-100 pt-6">
                        <!--begin::Title-->
                        <div class="text-center">
                            <h3 class="text-dark-75 font-weight-bold display4">570,600</h3>
                            <span
                                class="text-muted font-size-h5 font-weight-bold">Total Keen Admin Sales</span>
                        </div>
                        <!--end::Title-->
                        <!--begin::Chart-->
                        <div class="progress-vertical h-150px my-10">
                            <div class="progress bg-light-primary" data-toggle="tooltip" title=""
                                 data-original-title="40%">
                                <div class="progress-bar bg-primary" role="progressbar" style="height: 40%"
                            ...
                            <div class="progress bg-light-primary" data-toggle="tooltip" title=""
                                ...
                                <div class="progress-bar bg-primary" role="progressbar" style="height: 35%"
                                     aria-valuenow="30" aria-valuemin="0" aria-valuemax="100"></div>
                            </div>
                            <div class="progress bg-light-primary" data-toggle="tooltip" title=""
                                 data-original-title="50%">
                            ...
                            <div class="progress bg-light-primary" data-toggle="tooltip" title=""
                                ...
                                <div class="progress-bar bg-primary" role="progressbar" style="height: 60%"
                                     aria-valuenow="30" aria-valuemin="0" aria-valuemax="100"></div>
                            </div>
                            <div class="progress bg-light-primary" data-toggle="tooltip" title=""
                            ...
                            <div class="progress bg-light-primary" data-toggle="tooltip" title=""
                                ...
                                <div class="progress-bar bg-primary" role="progressbar" style="height: 90%"
                                     aria-valuenow="30" aria-valuemin="0" aria-valuemax="100"></div>
                            </div>
                            <div class="progress bg-light-primary" data-toggle="tooltip" title=""
                                 data-original-title="75%">
                                <div class="progress-bar bg-primary" role="progressbar" style="height: 75%"
                                     aria-valuenow="30" aria-valuemin="0" aria-valuemax="100"></div>
                            </div>
                        </div>
                        <!--end::Chart-->
                        <a href="#"
                           class="btn btn-dark opacity-80 font-weight-bolder font-size-lg w-100 py-3">Generate
                            Report</a>
                    </div>
                    <!--end::Container-->
                </div>
        ...
        <div class="col-lg-6">
            ...
            <div class="card card-custom card-stretch gutter-b">
                ...
                <div class="card-header border-0 pt-6">
                    <h3 class="card-title align-items-start flex-column">
                                    <span
                                        class="card-label font-weight-bolder font-size-h4 text-dark-75">Top Products</span>
                        <span
                            class="text-muted mt-3 font-weight-bold font-size-lg">240,000 Total Sales</span>
                    </h3>
                    <div class="card-toolbar">
                        <div class="dropdown dropdown-inline" data-toggle="tooltip" title=""
                             data-placement="left" data-original-title="Quick actions">
    ...
    <div class="card card-custom gutter-b">
        ...
        <div class="card-header border-0 py-5">
            <h3 class="card-title align-items-start flex-column">
                <span class="card-label font-weight-bold font-size-h4 text-dark-75">Memebrs Status</span>
                <span
                    ...
                    <tr>
                        <td class="pr-0 py-4">
                            <div class="symbol symbol-45 flex-shrink-0 mr-5 mt-1">
                                <img alt="Pic" src="assets/media/users/150-8.jpg">
                            </div>
                        </td>
                        <td class="pl-0">
                            <a href="#"
                        ...
                        <td class="text-right">
                            ...
                            <img src="assets/media/misc/stars.png" alt="image" style="width: 5.5rem">
                        </td>
                        <td class="text-right">
                        ...
                        <td class="pr-0 text-right">
                            <a href="#"
                               class="btn btn-light-primary font-weight-bolder font-size-sm">Setup</a>
                        </td>
                    </tr>
                    <tr>
                        <td class="pr-0 py-4">
