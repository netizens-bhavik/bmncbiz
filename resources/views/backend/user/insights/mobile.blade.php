@php
$performances = array();
if (isset($insights_data['mobile']['cls_score'])) {
    if ($insights_data['mobile']['cls_score'] < 50) {
        $performances['cls_score'] = '<span class="text-danger"> Poor </span>';
        $performances['cls_score_data'] = '<span class="text-danger"> '. $insights_data['mobile']['cls'] .'</span>';
    } elseif ($insights_data['mobile']['cls_score'] <= 89) {
        $performances['cls_score'] = '<span class="text-warning"> Needs improvement </span>';
        $performances['cls_score_data'] = '<span class="text-warning"> '. $insights_data['mobile']['cls'] .'</span>';
    } elseif ($insights_data['mobile']['cls_score'] <= 100) {
        $performances['cls_score'] = '<span class="text-success"> Good </span>';
        $performances['cls_score_data'] = '<span class="text-success"> '. $insights_data['mobile']['cls'] .'</span>';
    }
} else {
    $performances['cls_score'] = '<span class="text-secondary"> N/A </span>';
    $performances['cls_score_data'] = '<span class="text-secondary"> '. $insights_data['mobile']['cls'] .'</span>';
}

if (isset($insights_data['mobile']['fcp_score'])) {
    if ($insights_data['mobile']['fcp_score'] < 50) {
        $performances['fcp_score'] = '<span class="text-danger"> Poor </span>';
        $performances['fcp_time'] = '<span class="text-danger"> ' . $insights_data['mobile']['fcp_time'] . ' </span>';
    } elseif ($insights_data['mobile']['fcp_score'] <= 89) {
        $performances['fcp_score'] = '<span class="text-warning"> Needs improvement </span>';
        $performances['fcp_time'] = '<span class="text-warning"> ' . $insights_data['mobile']['fcp_time'] . ' </span>';
    } elseif ($insights_data['mobile']['fcp_score'] <= 100) {
        $performances['fcp_score'] = '<span class="text-success"> Good </span>';
        $performances['fcp_time'] = '<span class="text-success"> ' . $insights_data['mobile']['fcp_time'] . ' </span>';
    }
} else {
    $performances['fcp_score'] = '<span class="text-secondary"> N/A </span>';
    $performances['fcp_time'] = '<span class="text-secondary"> ' . $insights_data['mobile']['fcp_time'] . ' </span>';
}

if (isset($insights_data['mobile']['si_score'])) {
    if ($insights_data['mobile']['si_score'] < 50) {
        $performances['si_score'] = '<span class="text-danger"> Poor </span>';
        $performances['si_time'] = '<span class="text-danger"> ' . $insights_data['mobile']['si_time'] . ' </span>';
    } elseif ($insights_data['mobile']['si_score'] <= 89) {
        $performances['si_score'] = '<span class="text-warning"> Needs improvement </span>';
        $performances['si_time'] = '<span class="text-warning"> ' . $insights_data['mobile']['si_time'] . ' </span>';
    } elseif ($insights_data['mobile']['si_score'] <= 100) {
        $performances['si_score'] = '<span class="text-success"> Good </span>';
        $performances['si_time'] = '<span class="text-success"> ' . $insights_data['mobile']['si_time'] . ' </span>';
    }
} else {
    $performances['si_score'] = '<span class="text-secondary"> N/A </span>';
    $performances['si_time'] = '<span class="text-secondary"> ' . $insights_data['mobile']['si_time'] . ' </span>';
}

if (isset($insights_data['mobile']['tti_score'])) {
    if ($insights_data['mobile']['tti_score'] < 50) {
        $performances['tti_score'] = '<span class="text-danger"> Poor </span>';
        $performances['tti_time'] = '<span class="text-danger"> ' . $insights_data['mobile']['tti_time'] . ' </span>';
    } elseif ($insights_data['mobile']['tti_score'] <= 89) {
        $performances['tti_score'] = '<span class="text-warning"> Needs improvement </span>';
        $performances['tti_time'] = '<span class="text-warning"> ' . $insights_data['mobile']['tti_time'] . ' </span>';
    } elseif ($insights_data['mobile']['tti_score'] <= 100) {
        $performances['tti_score'] = '<span class="text-success"> Good </span>';
        $performances['tti_time'] = '<span class="text-success"> ' . $insights_data['mobile']['tti_time'] . ' </span>';
    }
} else {
    $performances['tti_score'] = '<span class="text-secondary"> N/A </span>';
    $performances['tti_time'] = '<span class="text-secondary"> ' . $insights_data['mobile']['tti_time'] . ' </span>';
}

if (isset($insights_data['mobile']['fmp_score'])) {
    if ($insights_data['mobile']['fmp_score'] < 50) {
        $performances['fmp_score'] = '<span class="text-danger"> Poor </span>';
        $performances['fmp_time'] = '<span class="text-danger"> ' . $insights_data['mobile']['fmp_time'] . ' </span>';
    } elseif ($insights_data['mobile']['fmp_score'] <= 89) {
        $performances['fmp_score'] = '<span class="text-warning"> Needs improvement </span>';
        $performances['fmp_time'] = '<span class="text-warning"> ' . $insights_data['mobile']['fmp_time'] . ' </span>';
    } elseif ($insights_data['mobile']['fmp_score'] <= 100) {
        $performances['fmp_score'] = '<span class="text-success"> Good </span>';
        $performances['fmp_time'] = '<span class="text-success"> ' . $insights_data['mobile']['fmp_time'] . ' </span>';
    }
} else {
    $performances['fmp_score'] = '<span class="text-secondary"> N/A </span>';
    $performances['fmp_time'] = '<span class="text-secondary"> ' . $insights_data['mobile']['fmp_time'] . ' </span>';
}

if (isset($insights_data['mobile']['lcp_score'])) {
    if ($insights_data['mobile']['lcp_score'] < 50) {
        $performances['lcp_score'] = '<span class="text-danger"> Poor </span>';
        $performances['lcp_time'] = '<span class="text-danger"> ' . $insights_data['mobile']['lcp_time'] . ' </span>';
    } elseif ($insights_data['mobile']['lcp_score'] <= 89) {
        $performances['lcp_score'] = '<span class="text-warning"> Needs improvement </span>';
        $performances['lcp_time'] = '<span class="text-warning"> ' . $insights_data['mobile']['lcp_time'] . ' </span>';
    } elseif ($insights_data['mobile']['lcp_score'] <= 100) {
        $performances['lcp_score'] = '<span class="text-success"> Good </span>';
        $performances['lcp_time'] = '<span class="text-success"> ' . $insights_data['mobile']['lcp_time'] . ' </span>';
    }
} else {
    $performances['lcp_score'] = '<span class="text-secondary"> N/A </span>';
    $performances['lcp_time'] = '<span class="text-secondary"> ' . $insights_data['mobile']['lcp_time'] . ' </span>';
}

if (isset($insights_data['mobile']['tbt_score'])) {
    if ($insights_data['mobile']['tbt_score'] < 50) {
        $performances['tbt_score'] = '<span class="text-danger"> Poor </span>';
        $performances['tbt_time'] = '<span class="text-danger"> ' . $insights_data['mobile']['tbt_time'] . ' </span>';
    } elseif ($insights_data['mobile']['tbt_score'] <= 89) {
        $performances['tbt_score'] = '<span class="text-warning"> Needs improvement </span>';
        $performances['tbt_time'] = '<span class="text-warning"> ' . $insights_data['mobile']['tbt_time'] . ' </span>';
    } elseif ($insights_data['mobile']['tbt_score'] <= 100) {
        $performances['tbt_score'] = '<span class="text-success"> Good </span>';
        $performances['tbt_time'] = '<span class="text-success"> ' . $insights_data['mobile']['tbt_time'] . ' </span>';
    }
} else {
    $performances['tbt_score'] = '<span class="text-secondary"> N/A </span>';
    $performances['tbt_time'] = '<span class="text-secondary"> ' . $insights_data['mobile']['tbt_time'] . ' </span>';
}
@endphp
                            ...
                            <div class="d-flex flex-wrap flex-row-fluid">
                                ...
                                <div class="d-flex flex-column pr-5 flex-grow-1">
                                    ...
                                    <span class="text-muted font-weight-bold"> <a
                                            href="{{ $insights_data['mobile']['sitemap'] }}" target="_blank"> Check
                                            Now </a> </span>
                                </div>
                                <!--end::Text-->
                                <!--begin::Section-->
                                <div class="d-flex align-items-center py-2">
                                    ...
                                    @php
                                        ...
                                        if ($insights_data['mobile']['sitemap'] == null) {
                    ...
                    <div class="card-body d-flex align-items-center justify-content-between pt-7 flex-wrap"
                        ...
                        <div class="d-flex align-items-center justify-content-between"
                            ...
                            <div class="d-flex flex-center position-relative" style="width: -webkit-fill-available;">
                                ...
                                <input type="hidden" id="mobile_cart_score"
                                    data-chartscrore="{{ $insights_data['mobile']['speed_score'] }}" name="score"
                                    value="{{ $insights_data['mobile']['speed_score'] }}" />
                                <div class="font-weight-bolder font-size-h5 text-muted position-absolute">
                                    <span
                                        class="text-dark-75 display-3 font-weight-bolder">{{ $insights_data['mobile']['speed_score'] }}/100</span>
                                </div>
                                <canvas id="mobile_insights_chart"
                    ...
                    <div class="card-body" style="padding: 0%">
                        <div class="d-flex align-items-center p-5">
                            ...
                            <div class="d-flex flex-column">
                                ...
                                <div class="text-dark-75 h3">
                                    {{ $insights_data['mobile']['total_backlinks'] }}
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-body" style="padding: 0%">
                        <div class="d-flex align-items-center p-5">
                            ...
                            <div class="d-flex flex-column">
                                ...
                                <div class="text-dark-75 h3">
                                    {{ $insights_data['mobile']['spam_score'] }}
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="card shadow p-3 mb-5 bg-white rounded card-custom card-stretch gutter-b">
            ...
            <div class="card-body pt-1 pb-4">
                <div class="tab-content mt-5" id="myTabTable1">
                    <!--begin::Tap pane-->
                    <div class="tab-pane fade active show" id="mobile_opportunities" role="tabpanel"
                        ...
                        <div class="table-responsive">
                            <table class="table table-borderless table-vertical-center">
                                ...
                                <tbody>
                                    @foreach ($insights_data['mobile']['opportunities'] as $opportunity)
                    ...
                    <!--begin::Tap pane-->
                    <div class="tab-pane fade" id="mobile_alerts" role="tabpanel"
