        ...
        <div class="login-aside d-flex flex-column flex-row-auto">
            ...
            <div class="d-flex flex-column-auto flex-column py-lg-20 py-10 mb-20">
                ...
                <a href="#" class="login-logo text-center pt-lg-10 pb-10">
                    <img src="{{ asset('public/assets/media/logos/logo-6.svg') }}" alt="logo" class="h-60px"/>
                </a>
                <!--end::Aside header-->
                <!--begin::Aside Title-->
            ...
            <div class="d-flex flex-row-fluid bgi-no-repeat bgi-position-x-center bgi-size-contain"
                 style="background-image: url({{ asset('public/assets/media/svg/illustrations/accomplishment.svg') }})"></div>
                ...
                <div class="login-form">
                    ...
                    <form class="form" id="login-form" method="POST" action="{{ route('login') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control h-auto py-6 rounded-lg border-0" type="text" id="email"
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control h-auto py-6 rounded-lg border-0" type="password" id="password"
